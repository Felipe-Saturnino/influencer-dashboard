...
-- linhas em role_permissions para streamers (Overview+Conversão+Financeiro executivos), etc.
--
...
INSERT INTO role_permissions (role, page_key, can_view, can_criar, can_editar, can_excluir) VALUES
  ...
  ('admin', 'streamers',          'sim', NULL, NULL, NULL),
...
INSERT INTO role_permissions (role, page_key, can_view, can_criar, can_editar, can_excluir) VALUES
  ...
  ('gestor', 'streamers',          'sim', NULL, NULL, NULL),
...
INSERT INTO role_permissions (role, page_key, can_view, can_criar, can_editar, can_excluir) VALUES
  ...
  ('executivo', 'streamers',          'sim', NULL, NULL, NULL),
...
INSERT INTO role_permissions (role, page_key, can_view, can_criar, can_editar, can_excluir) VALUES
  ...
  ('operador', 'streamers',          'sim', NULL, NULL, NULL),
...
INSERT INTO role_permissions (role, page_key, can_view, can_criar, can_editar, can_excluir) VALUES
  ...
  ('influencer', 'streamers',          'nao', NULL, NULL, NULL),
...
INSERT INTO role_permissions (role, page_key, can_view, can_criar, can_editar, can_excluir) VALUES
  ...
  ('agencia', 'streamers',          'nao', NULL, NULL, NULL),
