-- Cole no SQL Editor do Supabase (corrige Atender Feedback em Solicitações).
-- Erro anterior: stack depth limit exceeded (loop sol ↔ CT).
-- Espelha: supabase/migrations/20261209200000_rh_feedback_ct_sync_loop_fix.sql
