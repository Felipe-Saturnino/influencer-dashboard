...
6. Após implementar: `typecheck` na superfície tocada. Sugerir **`/smoke`** (mesmo chat) para validar em staging — ver skill `smoke`.
7. Commit/push **não**. Auditoria formal → `/verificacao` noutro chat.
