-- Escala do Mês: expõe cargo (função) para filtro na UI (Gerenciar / Gerar).
...
COMMENT ON FUNCTION public.rh_escala_prestadores_times() IS
  'RH Escala do Mês: staff (Studio Ops / CS) com cargo para filtro. Requer role_permissions(rh_escala_mes).can_view ou admin.';
