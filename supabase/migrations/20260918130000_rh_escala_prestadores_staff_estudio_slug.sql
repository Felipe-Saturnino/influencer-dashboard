-- Gestão de Escala: expor staff_estudio_slug no RPC para filtro por estúdio na UI.
...
COMMENT ON FUNCTION public.rh_escala_prestadores_times() IS
  'RH Gestão de Escala: staff com escala e staff_turno (Game Floor / Operation Management), exceto Contador de Cartas; inclui staff_estudio_slug para filtro na UI. Requer rh_gestao_escala efetivo ou role_permissions não‑prestador.';
