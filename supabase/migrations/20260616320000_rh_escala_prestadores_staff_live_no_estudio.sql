-- Gestão de Escala: expor staff_live_no_estudio (Live no Estúdio) para ancorar sugestão de escala.
...
COMMENT ON FUNCTION public.rh_escala_prestadores_times() IS
  'RH Gestão de Escala: staff Game Floor / Operation Management; inclui staff_live_no_estudio (Live no Estúdio) para ancorar sugestão de escala.';
