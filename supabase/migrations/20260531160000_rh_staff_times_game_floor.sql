-- Gerências alvo: "Game Floor" (ex-Studio Operations) e "Operation Management".
-- Corrige assinatura de rh_escala_prestadores_times (cargo + staff_turno) alinhada à migração 20260528130000.
...
COMMENT ON FUNCTION public.rh_escala_prestadores_times() IS
  'RH Escala do Mês: staff com escala e staff_turno (Game Floor / Operation Management). Requer rh_escala_mes.can_view ou admin.';
