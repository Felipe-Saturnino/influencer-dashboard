-- Customer Success — atuação agregador (exige empresa)
...
ALTER TABLE public.cs_chamados
  DROP CONSTRAINT IF EXISTS cs_chamados_empresa_quando_atuacao;
...
ALTER TABLE public.cs_chamados
  ADD CONSTRAINT cs_chamados_empresa_quando_atuacao CHECK (
