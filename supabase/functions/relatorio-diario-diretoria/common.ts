...
/**
 * Fim da janela de investimento Streamers no Relatório Diário.
 * Mês civil atual: hoje (BRT) — mesma regra do Overview Streamers.
 * Dia 1 (consolidado = mês anterior): ontem = último dia daquele mês.
 * Espelhado em src/lib/investimentoPago.ts.
 */
