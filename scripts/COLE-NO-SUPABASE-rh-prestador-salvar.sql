-- =============================================================================
-- COLE NO SUPABASE SQL Editor (projeto producao)
-- Corrige falha ao criar Novo Prestador (RPC rh_prestador_salvar).
-- Apos colar, teste: Gestao de Prestadores > Novo Prestador > Salvar.
-- =============================================================================
