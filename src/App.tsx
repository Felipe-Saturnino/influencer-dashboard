...
const Incidentes = lazyWithRetry(() => import("./pages/estudio/Incidentes"));
...
const EscalaEscritorio = lazyWithRetry(() => import("./pages/rh/EscalaEscritorio"));
...
const PAGE_MAP: Record<string, LazyExoticComponent<ComponentType>> = {
  ...
  escala_escritorio: EscalaEscritorio,
  ...
  escala_controle_turno: EscalaControleTurno,
