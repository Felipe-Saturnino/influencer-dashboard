  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 2100, display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }}>
      ...
      <div
        ...
        onClick={(e) => e.stopPropagation()}
      >
        <h2 id="modal-del-titulo" style={{ margin: "0 0 12px", fontSize: 16, fontWeight: 800, color: t.text }}>
          Excluir denúncia?
        </h2>
        <p style={{ margin: "0 0 18px", fontSize: 14, color: t.textMuted, lineHeight: 1.5 }}>
          Esta ação remove permanentemente o protocolo <strong style={{ color: t.text }}>{protocolo}</strong> e os dados associados.
        </p>
        <div style={{ display: "flex", justifyContent: "flex-end", gap: 10 }}>
          <button
            type="button"
            onClick={onClose}
            style={{ padding: "10px 16px", borderRadius: 10, border: `1px solid ${t.cardBorder}`, background: "transparent", color: t.text, cursor: "pointer", fontFamily: FONT.body }}
          >
            Cancelar
          </button>
          <button
