...
export const PAGES: {
  ...
  { key: "financeiro", label: "Financeiro", secao: "Financeiro", hasCriar: false, hasEditar: true, hasExcluir: false },
  { key: "banca_jogo", label: "Banca de Jogo", secao: "Financeiro", hasCriar: true, hasEditar: true, hasExcluir: true },
  ...
  { key: "rh_figurinos", label: "Figurinos", secao: "RH", hasCriar: true, hasEditar: true, hasExcluir: true },
