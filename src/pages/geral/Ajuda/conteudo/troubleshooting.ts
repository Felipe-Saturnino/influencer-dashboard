  ...
  streamers: {
    ...
    blocos: [
      ...
      },
      {
        ...
        texto:
          "Os cadastros por jogador (ID Ext + UTM) entram no mesmo sync da Casa de Apostas que atualiza as métricas consolidadas. A aba Jogadores conta o daily do mês no carrossel — não o acumulado lifetime do cadastro. **Todos Influencers** e **Todas Operadoras** respeitam o seu escopo: com permissão de Ver **próprios**, os KPIs são só dos seus cadastros e das suas casas — não da plataforma. Se Overview e Conversão têm números mas Jogadores não, o sync agregado rodou e a fase de IDs falhou — em geral falta permissão de relatório de registros na TAP. Rodadas, GGR Spin e “Jogaram Spin” só aparecem depois do cruzamento com as mesas ao vivo (Revenue Sentinel). Se o Status Técnico mostrar o sync do Revenue Sentinel **OK** com 0 registros no dia, o cadastro TAP existe mas os dias Spin não foram gravados — republicar a Edge `sync-revenue-sentinel` (inclui o ficheiro do parser) e rodar o Sync de novo. Enquanto esse cruzamento não gravar dias Spin, os KPIs de mesa ficam em 0 e os registros TAP do período continuam visíveis. Se o problema persistir, entre em contato com o suporte.",
      },
      {
