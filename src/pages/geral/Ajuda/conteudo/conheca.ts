  ...
  escala_marketplace_turnos: {
    ...
    blocos: [
      ...
      },
      {
        ...
        texto:
          "Com **Ver: Sim** e **Minhas Negociações** desligado, a aba **Ofertas Spin** concentra coberturas e liberações publicadas pela **Spin Gaming**. **Nova Oferta** nesta aba abre o modal operacional: **Time** (Game Presenter, Shuffler ou Liderança), **Cobertura de turno** ou **Liberação de vaga**, dia, turno, estúdio e observação. Publicar exige **4h** até o início do turno; aceite no mural atualiza a escala **na hora** (Compra - Turno ou Venda) — sem proposta Em análise. Coberturas entram no mural em **Ofertas de Turno**; liberações em **Ofertas de Folga**. A aba organiza **Ofertas abertas**, **Ofertas aceitas**, o bloco **Compra Turno / Compra Folga** (vendas P2P de GP e Shuffler — gestão propõe compra em nome da Spin Gaming; ofertante aprova em **Minhas Ofertas**) e **Histórico** (canceladas ou expiradas). Tutorial: `/Ajuda/Tutoriais/MarketplaceOfertasSpin`.",
      },
    ],
  },
