...
export const TUTORIAL_RH_SOLICITACOES_FEEDBACK: TutorialDef = {
  ...
  passos: [
    ...
    },
    {
      ...
      aviso:
        "Feedback registrado só nesta página (origem Solicitações de RH) **não** cria linha no Controle de Turno. O espelho bidirecional vale para origem Controle de Turno.",
    },
    {
