  ...
  passos: [
    {
      ...
      texto:
        "1. No menu, seção Escala, clique em **Marketplace**.\n2. Clique em **Ofertas Spin**. O botão **Nova Oferta** aparece só nesta aba.\n3. Mantenha o botão **Minhas Negociações** desligado para ver toda a gestão Spin, não só as suas negociações.\n4. A página organiza **quatro blocos**: **Ofertas abertas**, **Ofertas aceitas**, **Compra Turno / Compra Folga** e **Histórico**.\n5. Use o carrossel de mês, o filtro **Todas as Ações**, o filtro **Times** e a busca para localizar ofertas.",
      imagens: [
        {
    ...
    },
    {
      ...
      aviso:
        "Escolha o **Time** (Game Presenter, Shuffler ou Liderança) conforme quem poderá aceitar a oferta no mural. **Estúdio** só é pedido para Game Presenter.",
    },
    {
    ...
    },
    {
      ...
      texto:
        "A liderança também pode **comprar** vendas já publicadas no mural dos prestadores — sem esperar o colega aceitar cobertura Spin.\n\n1. Role até o bloco **Compra Turno** (abaixo de **Ofertas aceitas**).\n2. Use as abas **Compra Turno** ou **Compra Folga** na mesma linha do título — alternam vendas de turno e vendas de folga de **Game Presenter** e **Shuffler**.\n3. A tabela traz **Data da Oferta**, **Turno da Oferta**, **Ofertante**, **Time**, **Status** (quando houver proposta Em análise) e **Ações**.\n4. Com filtro **Todos Times** na barra, aparecem GP e Shuffler; filtre por time se precisar.\n5. Clique em **Aceitar em nome da Spin** (ícone de check) na linha desejada.\n6. No modal **Propor compra Spin**, confira ofertante, dia e turno. Clique em **Enviar proposta**.\n7. A oferta sai do mural e fica **Em análise** — continua visível neste bloco com status **Em análise**; o ofertante vê **Spin Gaming** como interessado e **aprova ou recusa** em **Minhas Ofertas**.\n8. Se a proposta foi enviada por engano, use **Desistir da proposta** (ícone de desfazer) na mesma linha — a oferta volta ao mural e o dia deixa de ficar reservado.\n9. Se aprovado: em **Compra Turno** o prestador libera o dia (**Venda**); em **Compra Folga** assume o turno (**Compra - Turno**). A Spin Gaming é a contraparte — **não há segunda célula** na grade.\n\n**Ofertas de Troca** e vendas de **Liderança** não entram neste bloco.",
      aviso:
        "Diferente da cobertura/liberação Spin, a compra sobre venda direta **exige aprovação do ofertante** antes de gravar a escala.",
      imagens: [
        {
