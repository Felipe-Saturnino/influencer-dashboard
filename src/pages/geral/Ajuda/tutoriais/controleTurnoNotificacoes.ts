...
export const TUTORIAL_CONTROLE_TURNO_NOTIFICACOES: TutorialDef = {
  ...
  passos: [
    ...
    },
    {
      ...
      texto:
        "1. Clique em **Registrar Ausência**.\n2. Selecione o **Time**, o **Prestador** e o **Motivo** (**Médico** ou **Pessoal**).\n3. Se o Motivo for **Pessoal**, aparece o campo obrigatório **Tipo de Ausência**:\n   — **Programada (aviso com 24h):** o prestador avisou a ausência com **pelo menos 24 horas** de antecedência em relação ao **início do seu turno**.\n   — **Não Programada (aviso com menos de 24h):** o prestador avisou com **menos de 24 horas** de antecedência ao início do turno.\n4. Informe o **Início da Ausência** e o **Fim da Ausência** (ou marque **Não informado** se o fim ainda não for conhecido).\n5. Preencha a **Observação** e salve. A linha fica no bloco com início, fim e liderança que registrou.\n6. Com **Editar**, atualize o fim quando a ausência encerrar — enquanto estiver aberta, o item segue aparecendo nos dias seguintes.\n\n**Motivo Médico:** use este quadro só se o prestador **ainda não tiver atestado**. Se já tiver o documento, o encaminhamento ao RH é pela página **Calendário** (fluxo de justificativa de presença). O **Tipo de Ausência** não aparece nesse caso.",
      imagens: [
        {
