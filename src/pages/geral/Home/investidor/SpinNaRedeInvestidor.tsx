...
export function SpinNaRedeInvestidor() {
  ...
  return (
    <section style={{ ...box, marginBottom: 14 }} aria-labelledby="home-investidor-spin-title">
      <h2 id="home-investidor-spin-title" style={{ ...homeInvestidorSectionTitleStyle(t.sectionTitle), marginBottom: 14 }}>
        Spin na Rede
      </h2>
