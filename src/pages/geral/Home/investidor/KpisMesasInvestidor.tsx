...
import { homeInvestidorSectionTitleStyle } from "./homeInvestidorUi";
...
export function KpisMesasInvestidor() {
  ...
  return (
    <section style={box} aria-labelledby="home-investidor-kpis-title">
      <h2 id="home-investidor-kpis-title" style={homeInvestidorSectionTitleStyle(t.sectionTitle)}>
        Principais KPIs
      </h2>
      ...
      {loading ? (
        ...
        <>
          ...
          <p style={{ margin: "16px 0 0", fontSize: 13, color: t.textMuted, fontFamily: FONT.body, lineHeight: 1.5 }}>
            Quer saber mais? Acessa o Dashboard de{" "}
            <button
              type="button"
              onClick={() => setActivePage("mesas_spin")}
              style={{
                background: "none",
                border: "none",
                padding: 0,
