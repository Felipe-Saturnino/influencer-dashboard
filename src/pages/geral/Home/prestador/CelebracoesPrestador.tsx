...
import { HomePrestadorCelebracaoCard } from "./HomePrestadorCelebracaoCard";
...
export function CelebracoesPrestador() {
  ...
  return (
    <>
      {aniversarioPessoal ? (
        <HomePrestadorCelebracaoCard
          sectionId="home-prestador-aniversario-title"
      ...
      {aniversarioEmpresa ? (
        <HomePrestadorCelebracaoCard
          sectionId="home-prestador-aniversario-empresa-title"
          titleIcon={Sparkles}
