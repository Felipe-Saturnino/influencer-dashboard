...
const ALL_PAGE_KEYS: PageKey[] = [
  ...
  "influencers", "scout", "afiliados", "afiliados_network", "financeiro", "banca_jogo", "gestao_links", "campanhas", "galeria_fotos", "comercial_overview", "comercial_pipeline_b2b", "comercial_pipeline_agregadoras", "cs_atendimento", "gestao_dealers", "central_notificacoes",
