...
import { TUTORIAL_FILTROS_PERFIL_LINHAS } from "../lib/ajudaTutorialVisibilidade";
...
export function TutorialPerfilMultiSelect({
  selected,
  onChange,
  t,
  hasError,
  ...
  return (
    <div
      role="group"
      aria-label="Perfis que verão este tutorial"
    ...
    >
      {TUTORIAL_FILTROS_PERFIL_LINHAS.map(({ titulo, roles }) => (
